        ...
        <section className='bg-[#002228] px-5'>
            <div className='flex justify-center py-20'>
                <div className='text-center '>
                    ...
                    <Button color="primary" radius="full" className='text-gray-900 w-full md:w-52 hover:scale-x-105 hover:shadow-md hover:shadow-primary transition-all mt-12'>Sign Up for the Beta<i class="fa-solid fa-arrow-up-right-from-square"></i></Button>
                </div>
            </div>
        </section>
     </>
